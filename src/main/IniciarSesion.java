...
public class IniciarSesion extends GeneralView{
    ...
    private void initializeComponents(){
        ...
        setLabel(IngSocCatchPhrase, "<html>&nbsp &nbsp &nbsp  Y recuerda...<br>El Gran Hermano te<br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp vigila</html>", new Font("Arial",Font.BOLD,18), IngSocColor.black);
