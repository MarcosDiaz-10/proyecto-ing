...
public class MainWindow extends JFrame implements ActionListener,ChangeListener{
    ...
    public MainWindow(){
        ...
        //Debería empezar con loginView pero como no está implementado aún no podemos pasar de login a mainpage, pero tenía que probar main page, por eso esta linea es sólo temporal
